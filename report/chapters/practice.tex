\chapter{Численные эксперименты}\label{chap4}
...
\section{Результаты}
Ниже приведен график результата программы, описанной выше. Прямые на графике -- соответсвующее отслеживаемые значения  $y^s_{1}$, $y^s_{2}$, которые, судя по графику, достигаются данной системной.

Результаты программной реализации алгоритма (\ref{Alg2}):
\begin{figure}[bh]\centering{
\includegraphics[width=150mm]{graphics/chap3.eps}}
\end{figure}
